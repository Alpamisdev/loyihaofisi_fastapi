...
def add_missing_columns():
    """Add missing columns to refresh_tokens table using direct SQLite connection."""
    try:
        ...
        if "token_hash" not in column_names:
            ...
            logger.info("Column 'token_hash' already exists")
        ...
        if "device_info" not in column_names:
            ...
            logger.info("Column 'device_info' already exists")
        ...
        logger.info("Successfully added all missing columns to refresh_tokens table")
        return True
