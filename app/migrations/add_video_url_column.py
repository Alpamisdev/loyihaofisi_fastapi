    ...
    try:
        with engine.connect() as conn:
            ...
            with conn.begin():
                ...
                if 'video_url' not in blog_posts_columns:
                    logger.info("Adding 'video_url' column to blog_posts table...")
                    conn.execute(text("ALTER TABLE blog_posts ADD COLUMN video_url VARCHAR"))
                ...
                conn.execute(text("CREATE INDEX IF NOT EXISTS ix_blog_posts_video_url ON blog_posts (video_url)"))
